...
val GrodnoRoads.Colored.TrafficPoliceBold: ImageVector
    get() {
        if (_TrafficPoliceBold != null) {
            return _TrafficPoliceBold!!
        }
        _TrafficPoliceBold = ImageVector.Builder(
            name = "Colored.TrafficPoliceBold",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 32f,
            viewportHeight = 32f
...
private var _TrafficPoliceBold: ImageVector? = null
