...
val GrodnoRoads.Outlined.Map: ImageVector
    get() {
        if (_Map != null) {
            return _Map!!
        }
        _Map = ImageVector.Builder(
            ...
            path(fill = SolidColor(Color(0xFFE676FF))) {
                ...
                arcToRelative(0.75f, 0.75f, 0f, false, false, -0.528f, -0.07f)
                lineToRelative(-5.49f, 1.3f)
                arcTo(0.75f, 0.75f, 0f, false, false, 3f, 5.092f)
                ...
                arcToRelative(0.737f, 0.737f, 0f, false, true, 0.55f, 0.07f)
                ...
                arcToRelative(0.75f, 0.75f, 0f, false, true, -0.556f, 0.725f)
                lineToRelative(-3.346f, 0.89f)
                arcToRelative(0.75f, 0.75f, 0f, false, true, -0.943f, -0.725f)
                lineTo(4.385f, 6.407f)
                arcToRelative(0.75f, 0.75f, 0f, false, true, 0.55f, -0.723f)
                lineToRelative(3.347f, -0.923f)
                arcToRelative(0.75f, 0.75f, 0f, false, true, 0.949f, 0.723f)
                verticalLineToRelative(10.44f)
                close()
                moveTo(19.615f, 17.593f)
                arcToRelative(0.75f, 0.75f, 0f, false, true, -0.55f, 0.723f)
                lineToRelative(-3.346f, 0.922f)
                arcToRelative(0.75f, 0.75f, 0f, false, true, -0.95f, -0.723f)
