...
val GrodnoRoads.Colored.RoadIncidentBold: ImageVector
    get() {
        if (_RoadIncidentBold != null) {
            return _RoadIncidentBold!!
        }
        _RoadIncidentBold = ImageVector.Builder(
            name = "Colored.RoadIncidentBold",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 32f,
            viewportHeight = 32f
...
private var _RoadIncidentBold: ImageVector? = null
