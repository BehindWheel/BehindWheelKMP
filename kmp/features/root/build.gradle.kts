...
kotlin {
    ...
    cocoapods {
        ...
        framework {
            ...
            export(projects.kmp.features.intro)
            ...
            export(projects.kmp.features.settings.debugTools)
    ...
    sourceSets {
        commonDependencies {
            ...
            api(projects.kmp.features.intro)
            ...
            api(projects.kmp.features.settings.debugTools)
